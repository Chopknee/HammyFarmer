...
namespace HammyFarming.Scenes.Spring01 {
    public class StartLetter: MonoBehaviour {
        ...
        private Vector2 levelImageEndSize = new Vector2(320.0f, 132.0f);
        ...
        public void Init () {
            ...
            slideInTimeout = new Brian.Utils.Timing.Timeout(32.5f);
            delayTimeout = new Brian.Utils.Timing.Timeout(20.0f);
        ...
        public void Update () {
            ...
            if (slideInTimeout.running) {
                ...
                float slideSlice = HammyFarming.Brian.Utils.Easing.EaseInOutCubic(slideInTimeout.GetNormalizedSlice(0.03125f, 0.066875f));
