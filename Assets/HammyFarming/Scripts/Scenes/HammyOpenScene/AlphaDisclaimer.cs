...
namespace HammyFarming.Scenes.HammyOpenScene {
    ...
    public class AlphaDisclaimer : MonoBehaviour {
        ...
        private void Update () {
            float btn1 = HammyFarming.Brian.Base.PlayerInput.ControlMaster.InputDevice.GamepadAnyButton.ReadValue<float>();
            float btn2 = HammyFarming.Brian.Base.PlayerInput.ControlMaster.InputDevice.KeyboardAnyButton.ReadValue<float>();
