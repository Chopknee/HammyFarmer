...
namespace HammyFarming.Hammy {
    ...
    public class BallControl: MonoBehaviour {
        ...
        public Rigidbody toolAnchor;

        public static Transform CameraTrackTransform;
        public static Rigidbody toolAnchorPoint;
        ...
        void Start () {
            ...
            HammyFarming.Brian.GameManagement.PlayerInput.ControlMaster.Hammy.Jump.performed += Jump;
        ...
        void Update () {
            ...
            Transform camTransform = HammyFarming.Brian.Director.LevelCamera.transform;
            ...
            Vector2 axes = HammyFarming.Brian.GameManagement.PlayerInput.ControlMaster.Hammy.Roll.ReadValue<Vector2>();
