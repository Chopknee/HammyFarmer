...
namespace HammyFarming.Tools.Harvester {
    ...
    public class Driving : MonoBehaviour {
        ...
        private void Awake() {
            ...
            activateTimeout = new HammyFarming.Brian.Utils.Timing.Timeout(activationTime, false);
            deactivateTimeout = new HammyFarming.Brian.Utils.Timing.Timeout(activationTime, false);
        ...
        private void Update() {
            ...
            if (capturing) {
                ...
                Vector2 rollDirection = HammyFarming.Brian.GameManagement.PlayerInput.ControlMaster.Hammy.Roll.ReadValue<Vector2>();
