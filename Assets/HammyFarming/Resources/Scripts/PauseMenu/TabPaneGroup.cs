...
namespace HammyFarming.PauseMenu {
    ...
    public class TabPaneGroup: MonoBehaviour {
        ...
        void Start () {
            Initialize();
            HammyFarming.Brian.GameManagement.PlayerInput.ControlMaster.UI.NextTab.performed += ShowNextPane;
            HammyFarming.Brian.GameManagement.PlayerInput.ControlMaster.UI.PreviousTab.performed += ShowPreviousPane;
        }
